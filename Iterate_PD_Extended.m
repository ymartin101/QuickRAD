...
% EEE4022S (2018)
% Iterate_PD_Extended.m: Iterate through PD_Extended to find PD and PFA for a varying parameter
...
for Variable = variable_array   % change Variable in "PD_Extended" file
    [PD,PFA] = PD_Extended(Variable);
